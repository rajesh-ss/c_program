 ...
 * @file q2_arr.c
 * @author Rajesh S
 * @brief Generate a Structure of coeffient, degree 'Using ARRAY'
 * @version 0.1
 * @date 2022-04-30
 *
...
int get_arr_usr(std arr[])
{
    ...
    for (i = 0; i < arr_size; i += 1)
    {
        ...
        printf("\nEnter your coeffient:\t");
        scanf("%d", &arr[i].coeffient);
...
void dis_arr(std *arr, int arr_size){
    ...
    char *prt_det[] = {"coeffient", "degree"};
    char *und[] = {"______", "___________"};
    int i=0;
   ...
   // printf("\n_______________________________________________________\n");
    ...
    for(i=0; i<arr_size; i+=1){
        ...
        printf("\n\t%*d | %*d \n", -9, arr[i].coeffient, -MAX, arr[i].degree);
    }
